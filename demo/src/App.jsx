import { SignIn, SignUp, SignedIn, SignedOut, useAuth, useClerk, useUser } from "./mockClerk.jsx";
...
const translations = {
  en: {
    ...
    auth: {
      ...
      description: "Use the local demo account to explore repository telemetry and protected routes.",
      ...
      missingDescription: "Demo authentication is configured locally and does not require environment variables.",
    },
    service: {
  ...
  es: {
    ...
    auth: {
      ...
      description: "Usa la cuenta local de demo para explorar telemetria del repositorio y rutas protegidas.",
      ...
      missingDescription: "La autenticacion de demo esta configurada localmente y no requiere variables de entorno.",
    },
    service: {
      ...
      <section className="modal-panel delete-repo-modal" role="dialog" aria-modal="true" aria-labelledby="delete-repo-title">
        ...
        <div className="modal-form">
          ...
          <footer className="modal-actions">
            ...
            <button className="danger-button" disabled type="button" onClick={onConfirm}>{copy.removeRepository}</button>
          </footer>
        </div>
      </section>
    </div>
      ...
      <div className="settings-stack">
        ...
        <SettingsPanel eyebrow={copy.settings.dangerEyebrow} title={copy.settings.dangerTitle}>
          <div className="danger-actions">
            ...
            <button className="danger-button" disabled type="button" onClick={onDeleteRepository}>{copy.settings.removeRepository}</button>
            </div>
            <div className="danger-action-row">
              <div>
              ...
              <button className="danger-button" disabled type="button" onClick={onDeleteAccount}>{copy.settings.deleteAccount}</button>
            </div>
          </div>
        </SettingsPanel>
      </div>
